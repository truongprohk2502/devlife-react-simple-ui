...
export const ratingVariants = cva(
  "appearance-none transition-all duration-150 active:-translate-y-0.5 bg-neutral-300 cursor-pointer disabled:cursor-not-allowed disabled:opacity-50",
  {
    variants: {
      color: {
