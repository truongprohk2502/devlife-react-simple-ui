...
export const inputVariants = cva(
  [
    "rounded-md border focus:border-neutral-600 focus:outline-none text-sm disabled:bg-neutral-300 disabled:text-neutral-400",
    "border-neutral-300 data-[invalid=true]:border-red-500",
  ],
  {
    variants: {
      inputSize: {
